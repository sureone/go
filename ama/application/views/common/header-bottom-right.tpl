...
{if $logined eq "true"}
<span class="user"><a href="./v/user/{$user.userid}/">{$user.userid}</a>&nbsp;(<span class="userkarma" title="post karma">1</span>)</span><span class="separator">|</span><a title="沒有新郵件" href="./v/message/inbox/" class="nohavemail" id="mail">信息</a>
<!-- 
